...
# EEG data
setwd("~/Dropbox/PhD/Study_5_EEG/Plots")
library(circlize)
...
pdf("MedianBeta_ASC.pdf",width=12,height=12,paper='special') 
col_mat = col_fun(cor_mat)
col_mat[abs(cor_mat) < 0.2394] = "#00000000" # set threshold to transparent
